package OOP.WorkingWithAbstaction.Exercise._5_JediGalaxy;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!"Let the Force be with you".equals(command = scanner.nextLine())) {
            peterCoordinates = Arrays.stream(command.split(" ")).mapToInt(Integer::parseInt).toArray();
            evilCoordinates = Arrays.stream(scanner.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray();
